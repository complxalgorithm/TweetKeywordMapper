...
pls = ['NYC via ME', 'Boston -> Washington, D.C.', '848 from 716', 'Morgantown, West Virginia', '716 West Dr.', 'ÜT: 38.890550,-77.009017', '38.890550, -77.009017', '43°12′51″N,77°56′22″W', '43°12′51″N, 77°56′22″W']
...
for pl in pls:
    ...
    if pl.find('ÜT: ') != -1 or pl.find('°') != -1:
        ...
        if (len(pl.split(',')) > 1 or len(pl.split(', ')) > 1 or len(pl.split(' ')) > 1) and 
